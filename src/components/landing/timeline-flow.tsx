...
const etapas: Etapa[] = [
  ...
  { id:8, nombre:"Post-Tratamiento", icono:"💊", color:"#14b8a6", quien_actua:"Sistema Automático", tipo_actor:"sistema", descripcion_corta:"Recomendaciones automáticas por WhatsApp según el procedimiento", descripcion_larga:"Al salir de la clínica, el sistema activa una secuencia de mensajes personalizados según el procedimiento realizado. Ejemplo (ácido hialurónico en labios o implante capilar): Día 0 (7pm) — cuidados inmediatos. Día 1 — cómo manejar la inflamación o lavado de zona receptora. Día 3 — evolución normal. Día 7 — encuesta de satisfacción y oferta de control. Todo automático.", modulo_relacionado:"Módulo 6 — Comunicación Automatizada", que_pasa_por_detras:"Al marcar la cita como 'completada', el sistema busca la plantilla de mensajes para ese tipo de procedimiento. Programa los envíos para las fechas y horas correctas. Cada mensaje se personaliza con el nombre de la paciente.", resultado:"Paciente se siente cuidada. Menos complicaciones. Menos llamadas con preguntas." },
  ...
  { id:10, nombre:"Reactiva", icono:"🔄", color:"#06b6d4", quien_actua:"Sistema Automático", tipo_actor:"sistema", descripcion_corta:"Recordatorios cíclicos para tratamientos que requieren renovación", descripcion_larga:"El sistema calcula automáticamente cuándo cada paciente debe volver según el procedimiento: toxina botulínica cada 4-6 meses, ácido hialurónico cada 12-18 meses, controles post-tratamiento al mes/3 meses/6 meses/1 año. Envía mensaje automático: 'Andrea, han pasado 4 meses desde tu toxina. ¿Quieres renovar?' Si responde SÍ, la IA agenda automáticamente.", modulo_relacionado:"Módulo 14 — Fidelización y Reactivación", que_pasa_por_detras:"Cron job diario escanea pacientes con procedimientos que requieren renovación. Cruza la fecha del último procedimiento con la ventana de reactivación. Genera mensaje personalizado. Si el paciente no responde en 48h, se programa un segundo intento en 2 semanas.", resultado:"Pacientes que vuelven solos. $48M/año estimados solo en renovaciones de toxina (100 pacientes × 60% de retorno × $800.000)." },
